...
export default function Layanan() {
  ...
  const serviceSchema = {
    ...
    '@type': 'Service',
    serviceType: 'Jasa Instalasi Panel Surya & PLTS Atap',
    provider: {
      '@type': 'LocalBusiness',
      name: 'PT. Toba Energi Nusajaya',
      url: 'https://tobaenergi.com',
    },
    areaServed: 'Jabodetabek dan Seluruh Indonesia',
    hasOfferCatalog: {
      '@type': 'OfferCatalog',
      name: 'Paket Layanan Panel Surya End-to-End',
      itemListElement: [
        {
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: 'Instalasi PLTS On-Grid',
            description: 'Sistem panel surya tanpa baterai yang terhubung langsung dengan PLN untuk penghematan biaya listrik optimal.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: 'Instalasi PLTS Hybrid',
            description: 'Sistem panel surya dengan baterai cadangan yang menjamin suplai listrik anti-padam untuk hunian dan bisnis.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: 'Instalasi PLTS Off-Grid',
            description: 'Sistem mandiri energi 100% untuk area terpencil tanpa jaringan PLN.',
          },
        },
        {
          '@type': 'Offer',
          itemOffered: {
            '@type': 'Service',
            name: 'Perizinan SLO & Net Metering PLN',
            description: 'Pengurusan legalitas Sertifikat Laik Operasi dan kuota instalasi ke PLN tanpa repot.',
          },
        },
      ],
    },
  ...
  return (
    <>
      <SEO
        title="Layanan Pemasangan PLTS End-to-End | On-Grid, Off-Grid & Hybrid"
        description="Layanan pemasangan panel surya lengkap dari PT Toba Energi Nusajaya: konsultasi, instalasi teknisi bersertifikat ESDM, perizinan SLO PLN, hingga garansi performa 25+ tahun."
        keywords="layanan pasang panel surya, plts on grid bogor, plts hybrid jakarta, perizinan slo pln panel surya, kontraktor solar panel bekasi, toba energi layanan"
