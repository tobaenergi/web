...
export default function Home() {
  const localBusinessSchema = {
    ...
    alternateName: 'Toba Energi',
    image: 'https://tobaenergi.com/images/logo.png',
    '@id': 'https://tobaenergi.com/#business',
    url: 'https://tobaenergi.com',
    telephone: '+62-853-7071-6686',
    email: 'info@tobaenergi.com',
    priceRange: '$$',
    address: {
      '@type': 'PostalAddress',
      streetAddress: 'Jl. Raya Kertamaya No. 1, Kertamaya',
      addressLocality: 'Bogor Selatan, Kota Bogor',
    ...
    sameAs: [
      'https://www.instagram.com/tobaenergi/',
      'https://www.linkedin.com/company/toba-energi/',
    ],
  };
  ...
  return (
    <>
      <SEO
        title="Jasa Pasang Panel Surya Bogor & Jabodetabek | Solusi PLTS Hemat Listrik"
        description="PT Toba Energi Nusajaya menyediakan jasa instalasi panel surya (PLTS) end-to-end terpercaya untuk rumah, bisnis, dan industri di Bogor, Jabodetabek, dan seluruh Indonesia. Garansi 25+ tahun, teknisi tersertifikasi."
        keywords="jasa pasang panel surya bogor, pasang panel surya jabodetabek, plts atap rumah, jasa instalasi solar panel, biaya pasang solar cell jakarta, kontraktor plts indonesia, toba energi"
        canonicalPath="/"
