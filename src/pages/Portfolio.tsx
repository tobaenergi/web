...
export default function Portfolio() {
  ...
  return (
    <>
      <SEO
        title="Portofolio Proyek Instalasi Panel Surya | Toba Energi Nusajaya"
        description="Dokumentasi proyek instalasi PLTS atap oleh PT Toba Energi Nusajaya di Bekasi, Rancamaya Bogor, Tanjung Priok Jakarta, Sentul, dan kawasan lainnya."
        keywords="portofolio plts, proyek panel surya bekasi, instalasi plts rancamaya bogor, proyek solar cell jakarta, hasil pasang plts sentul, toba energi portofolio"
          ...
          >
            <div className="rounded-3xl overflow-hidden shadow-2xl ring-1 ring-gray-200 bg-gray-50/50 aspect-video relative">
              <iframe 
                ...
                title="Dokumentasi Video Instalasi Panel Surya Toba Energi" 
                frameBorder="0" 
              ...
              {projects.map((project, index) => (
                ...
                >
                  <div className="relative h-56 overflow-hidden">
                    <img 
                      src={project.image} 
                      alt={`${project.title} kapasitas ${project.capacity} di ${project.location} oleh Toba Energi`}
                      loading="lazy" 
