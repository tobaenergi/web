...
export default function TentangKami() {
  const organizationSchema = {
    ...
    description:
      'Perusahaan EPC penyedia layanan instalasi pembangkit listrik tenaga surya (PLTS) terpercaya untuk rumah, bisnis, dan industri di Indonesia.',
    address: {
      '@type': 'PostalAddress',
  ...
  return (
    <>
      <SEO
        title="Tentang Kami | Profil PT Toba Energi Nusajaya"
        description="Profil PT Toba Energi Nusajaya, pelopor solusi instalasi PLTS atap dan transisi energi terbarukan di Indonesia sejak 2016. Berpengalaman di daerah 3T hingga kawasan residensial & industri Jabodetabek."
        keywords="tentang toba energi, pt toba energi nusajaya, profil perusahaan plts, kontraktor solar panel indonesia, legalitas toba energi"
